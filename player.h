...
struct Player
{
  ...
  //Extract out of plyr setting and add to plyr.mapQuest[1,0]  as this is only the dungeon
  ...
  //Extract out of plyr setting and add to plyr.mapQuest[0,0]  as this is only the dungeon
  int healerDays[2];
  int healerHours[2];
  int healerMinutes[2];
